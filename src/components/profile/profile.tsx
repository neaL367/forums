        ...
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row text-center sm:text-start items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-medium text-2xl mb-2">{member.displayUsername}</h3>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-xl font-bold mb-2">{format(new Date(member.joinDate), "MMM yyyy")}</div>
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-xl font-bold mb-2">{format(new Date(member.lastActive), "MMM dd")}</div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <span className="text-muted-foreground">
                  {member.location || <span className="italic">Not specified</span>}
                </span>
              </div>
            </div>
          </CardContent>
