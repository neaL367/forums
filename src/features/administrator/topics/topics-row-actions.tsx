...
import { MoreHorizontal, Edit, Trash2, Settings, MessageCircle, Pin, Lock } from "lucide-react"
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="flex h-8 w-8 p-0 data-[state=open]:bg-muted" aria-label="Open actions menu">
