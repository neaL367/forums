...
const navItems = [
  ...
  { href: "/account-settings/change-username", label: "Username", icon: User },
  { href: "/account-settings/change-password", label: "Password", icon: Lock },
  { href: "/account-settings/change-email", label: "Email", icon: Mail },
];
